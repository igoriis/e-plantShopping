        ...
        <div>
            ...
            {!showCart ? (
                <div className="product-grid">
                    ...
                    <div key={index}> 
                        <h1>
                        <div style={styleH1Div}>{category.category}</div> 
                        </h1>
                        <div className="product-list">
                        {category.plants.map((plant, plantIndex) => {
                            const isAlreadyInCart = cart.some(item => item.name === plant.name);
                            return ( 
                            ...
                            <button
                                className={`product-button ${isAlreadyInCart ? 'disabled' : ''}`}
